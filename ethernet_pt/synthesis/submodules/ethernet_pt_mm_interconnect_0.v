// ethernet_pt_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module ethernet_pt_mm_interconnect_0 (
		...
		output wire [7:0]  tse_0_control_port_address,              //                tse_0_control_port.address
		output wire        tse_0_control_port_write,                //                                  .write
		output wire        tse_0_control_port_read,                 //                                  .read
		input  wire [31:0] tse_0_control_port_readdata,             //                                  .readdata
		output wire [31:0] tse_0_control_port_writedata,            //                                  .writedata
		input  wire        tse_0_control_port_waitrequest,          //                                  .waitrequest
		output wire [7:0]  tse_1_control_port_address,              //                tse_1_control_port.address
		output wire        tse_1_control_port_write,                //                                  .write
		output wire        tse_1_control_port_read,                 //                                  .read
		input  wire [31:0] tse_1_control_port_readdata,             //                                  .readdata
		output wire [31:0] tse_1_control_port_writedata,            //                                  .writedata
		input  wire        tse_1_control_port_waitrequest           //                                  .waitrequest
	);
	...
	wire  [12:0] tse_0_control_port_agent_m0_address;                                         // tse_0_control_port_agent:m0_address -> tse_0_control_port_translator:uav_address
	wire   [3:0] tse_0_control_port_agent_m0_byteenable;                                      // tse_0_control_port_agent:m0_byteenable -> tse_0_control_port_translator:uav_byteenable
	wire         tse_0_control_port_agent_m0_read;                                            // tse_0_control_port_agent:m0_read -> tse_0_control_port_translator:uav_read
	wire         tse_0_control_port_agent_m0_readdatavalid;                                   // tse_0_control_port_translator:uav_readdatavalid -> tse_0_control_port_agent:m0_readdatavalid
	wire         tse_0_control_port_agent_m0_lock;                                            // tse_0_control_port_agent:m0_lock -> tse_0_control_port_translator:uav_lock
	wire  [31:0] tse_0_control_port_agent_m0_writedata;                                       // tse_0_control_port_agent:m0_writedata -> tse_0_control_port_translator:uav_writedata
	wire         tse_0_control_port_agent_m0_write;                                           // tse_0_control_port_agent:m0_write -> tse_0_control_port_translator:uav_write
	wire   [2:0] tse_0_control_port_agent_m0_burstcount;                                      // tse_0_control_port_agent:m0_burstcount -> tse_0_control_port_translator:uav_burstcount
	wire         tse_0_control_port_agent_rf_source_valid;                                    // tse_0_control_port_agent:rf_source_valid -> tse_0_control_port_agent_rsp_fifo:in_valid
	wire  [87:0] tse_0_control_port_agent_rf_source_data;                                     // tse_0_control_port_agent:rf_source_data -> tse_0_control_port_agent_rsp_fifo:in_data
	wire         tse_0_control_port_agent_rf_source_ready;                                    // tse_0_control_port_agent_rsp_fifo:in_ready -> tse_0_control_port_agent:rf_source_ready
	wire         tse_0_control_port_agent_rf_source_startofpacket;                            // tse_0_control_port_agent:rf_source_startofpacket -> tse_0_control_port_agent_rsp_fifo:in_startofpacket
	wire         tse_0_control_port_agent_rf_source_endofpacket;                              // tse_0_control_port_agent:rf_source_endofpacket -> tse_0_control_port_agent_rsp_fifo:in_endofpacket
	wire         tse_0_control_port_agent_rsp_fifo_out_valid;                                 // tse_0_control_port_agent_rsp_fifo:out_valid -> tse_0_control_port_agent:rf_sink_valid
	wire  [87:0] tse_0_control_port_agent_rsp_fifo_out_data;                                  // tse_0_control_port_agent_rsp_fifo:out_data -> tse_0_control_port_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> nios2_debug_mem_slave_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                       // nios2_debug_mem_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> nios2_debug_mem_slave_agent:cp_channel
	...
	wire  [86:0] nios2_debug_mem_slave_agent_rp_data;                                         // nios2_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [86:0] cmd_demux_001_src0_data;                                                     // cmd_demux_001:src0_data -> cmd_mux_002:sink1_data
	...
	wire  [86:0] cmd_demux_001_src1_data;                                                     // cmd_demux_001:src1_data -> cmd_mux_003:sink1_data
	...
	wire  [86:0] rsp_demux_002_src1_data;                                                     // rsp_demux_002:src1_data -> rsp_mux_001:sink0_data
	...
	wire  [86:0] rsp_demux_003_src1_data;                                                     // rsp_demux_003:src1_data -> rsp_mux_001:sink1_data
	...
	ethernet_pt_mm_interconnect_0_router router (
	...
	ethernet_pt_mm_interconnect_0_router_001 router_001 (
	...
	ethernet_pt_mm_interconnect_0_router_004 router_004 (
	...
	ethernet_pt_mm_interconnect_0_router_004 router_005 (
	...
	ethernet_pt_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (sys_clk_clk_clk),                         //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_pt_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (sys_clk_clk_clk),                         //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_pt_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (sys_clk_clk_clk),                         //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_pt_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (sys_clk_clk_clk),                         //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_pt_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (sys_clk_clk_clk),                         //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_pt_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (sys_clk_clk_clk),                         //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_pt_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (sys_clk_clk_clk),                         //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_pt_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (sys_clk_clk_clk),                         //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_pt_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (sys_clk_clk_clk),                         //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_pt_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (sys_clk_clk_clk),                         //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_pt_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (sys_clk_clk_clk),                         //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_pt_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (sys_clk_clk_clk),                         //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_pt_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
